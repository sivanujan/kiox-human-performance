...
export function getSessionAssignmentTemplate(
  name: string,
  sessionTitle: string,
  date: string,
  time: string,
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>KIO-X Session Assignment</title>
      <style>
        @import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@700;900&family=Inter:wght@400;700;900&display=swap');
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h1>Session Assignment</h1>
          <p>Hello <strong>${name}</strong>, you have a new ${role} assignment on the KIO-X Elite platform.</p>
...
export function getBulkSessionAssignmentTemplate(
  name: string,
  date: string,
  role: string,
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>KIO-X Session Assignments</title>
      <style>
        @import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@700;900&family=Inter:wght@400;700;900&display=swap');
    ...
    <body>
      <div class="container">
        <div class="header">
          <div class="logo">KIO-X</div>
          <div class="badge">New Assignments</div>
        </div>
        
        <div class="content">
          <h1>Session Assignments</h1>
          <p>Hello <strong>${name}</strong>, you have new ${role} assignments for <strong>${date}</strong> on the KIO-X Elite platform.</p>
