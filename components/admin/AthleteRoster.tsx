                  ...
                  <div className="flex items-center gap-2 ml-auto">
                    {[
                      ...
                      <button
                        key={idx}
                        onClick={btn.action}
                        className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/20 hover:text-[#22c55e] hover:bg-white hover:border-white transition-all group/btn"
                        title={btn.label}
                      >
                         {btn.icon}
                      </button>
