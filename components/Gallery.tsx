      ...
      >
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', bottom: '16px', left: '16px', right: '16px' }}>
            <div className="font-display" style={{ color: '#ffffff', fontSize: '20px', letterSpacing: '0.05em', textTransform: 'uppercase', textShadow: '0 2px 10px rgba(0,0,0,0.8)' }}>
              {item.title}
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div className="font-display" style={{ color: '#22c55e', fontSize: '11px', letterSpacing: '0.3em', marginBottom: '6px', textTransform: 'uppercase' }}>
              {item.category}
            </div>

            <div className="font-display" style={{ color: '#ffffff', fontSize: '22px', marginBottom: '16px', textTransform: 'uppercase', lineHeight: 1.1 }}>
              {item.title}
            </div>
      ...
      <div style={{
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', marginBottom: '16px' }}>
            ...
            <span className="font-display" style={{ color: '#22c55e', fontSize: '12px', letterSpacing: '0.4em' }}>
              KIO-X MEDIA
            </span>
            <div style={{ width: '50px', height: '1px', background: 'linear-gradient(90deg, #22c55e, transparent)' }} />
          </div>

          <h1 className="font-display" style={{ color: '#ffffff', fontSize: 'clamp(48px, 8vw, 100px)', margin: '0 0 16px', textTransform: 'uppercase', lineHeight: 1 }}>
            GALLERY
          </h1>
      ...
      <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '0 30px' }}>
        ...
        {filtered.length === 0 && (
          <div style={{ textAlign: 'center', padding: '80px 20px', color: '#444444' }}>
            ...
            <div className="font-display" style={{ fontSize: '24px', color: '#333333' }}>
              NO ITEMS FOUND
            </div>
          </div>
        )}
