  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute top-8 left-8 w-16 h-16 border-t-[3px] border-l-[3px] border-[#22c55e]/60"></div>
        <div className="absolute top-8 right-8 w-16 h-16 border-t-[3px] border-r-[3px] border-[#22c55e]/60"></div>
        <div className="absolute bottom-8 left-8 w-16 h-16 border-b-[3px] border-l-[3px] border-[#22c55e]/60"></div>
        <div className="absolute bottom-8 right-8 w-16 h-16 border-b-[3px] border-r-[3px] border-[#22c55e]/60"></div>
      </div>
      ...
      <div className="container relative z-20 mx-auto px-4 text-center flex flex-col items-center mt-16 md:mt-24 w-full pointer-events-none">
        <div className="flex flex-col items-center w-full">
          <h1 className="font-display font-bold leading-[0.85] tracking-tighter uppercase mb-6 sm:mb-8 text-[12vw] sm:text-[10vw] md:text-[9vw] lg:text-[130px] flex flex-col items-center drop-shadow-2xl">
          ...
          >
            <Link 
              href="#services"
              className="group relative inline-flex items-center justify-center px-12 py-5 font-bold tracking-widest text-[#080808] uppercase transition-all duration-300 bg-[#22c55e] hover:scale-[1.05] shadow-[0_0_20px_rgba(34,197,94,0.6)] hover:shadow-[0_0_50px_rgba(34,197,94,0.9)] overflow-hidden rounded-full"
            >
              <div 
