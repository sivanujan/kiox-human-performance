  ...
  return (
    <div className="bg-[#111] border border-white/5 rounded-3xl p-6 relative overflow-hidden group">
      <div className="flex justify-between items-start mb-6">
        <div>
          <div className="text-white/20 text-[10px] font-black tracking-[3px] uppercase mb-1">PHYSIOLOGICAL DATA</div>
          <h3 className={`${anton.className} text-xl text-white tracking-widest uppercase`}>My Weekly Load</h3>
        </div>
      ...
      <div className="flex items-baseline gap-2 mb-4">
         <span className={`${anton.className} text-5xl`} style={{ color: getStatusColor(currentAu) }}>
           {currentAu}
         </span>
         <span className="text-xs text-white/20 font-bold tracking-widest uppercase">AU TOTAL</span>
      </div>

      <div className="space-y-2 mb-6">
         <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
            <span style={{ color: getStatusColor(currentAu) }}>{currentStatus}</span>
            <span className="text-white/20">TARGET: {targetMin}-{targetMax}</span>
         </div>
      ...
      <div className="pt-4 border-t border-white/5">
         <div className="flex justify-between items-center mb-3">
            <div className="text-[9px] text-white/30 font-black uppercase tracking-widest flex items-center gap-1">
         ...
         <div className="h-12 w-full">
            {trendData.length > 0 ? (
              ...
              <div className="h-full flex items-center justify-center text-[8px] text-white/10 uppercase font-black tracking-widest">
      ...
      <div className="absolute -bottom-4 -right-4 opacity-[0.02] font-['Anton'] text-7xl pointer-events-none group-hover:opacity-[0.05] transition-opacity">
        LOAD
      </div>
    </div>
  );
