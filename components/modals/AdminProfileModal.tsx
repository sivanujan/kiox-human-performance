        ...
        >
          ...
          >
              ...
              {success ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button 
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 bg-[#22c55e] text-black text-[12px] font-black uppercase tracking-[3px] rounded-xl hover:bg-white transition-all shadow-[0_10px_30px_rgba(34,197,94,0.3)] flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
            ...
            <div className="p-6 border-t border-white/5 bg-[#080808] flex items-center justify-center gap-3 opacity-20 text-[9px] font-bold uppercase tracking-[4px]">
               <ShieldCheck size={14} /> Level 5 administrative Clearance Verified
            </div>
          </motion.div>
        </motion.div>
      )}
